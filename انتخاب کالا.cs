...
namespace فروش
{
    public partial class انتخاب_کالا : Form
    {
        public string kind, value,a,b,c,d,f,g,h,i,j,k,l;
        public int flag = 0;
        public انتخاب_کالا(ref string a, ref string b, ref string c, ref string d, ref string f, ref string g, ref string h, ref string i, ref string j, ref string k, ref string l)
        {
            InitializeComponent();
            this.a = a;
            this.b = b;
        ...
        private void انتخاب_کالا_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
          ...
          //  dataGridView1.SelectedCells = 0;
                ...
                h = this.data.CurrentRow.Cells[8].Value.ToString();
