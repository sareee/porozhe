...
namespace PrintDataGrid
{
    class PrintDGV
    {
        ...
        private static DataGridView datagrideview2;        // Holds DataGridView Object to print its contents
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                foreach (DataGridViewColumn c in datagrideview2.Columns)
                {
                    ...
                    System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                TotalWidth = 0;
                foreach (DataGridViewColumn GridCol in datagrideview2.Columns)
                {
                    ...
                    System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            try
            {
                ...
                while (RowPos <= datagrideview2.Rows.Count - 1)
                {
                    DataGridViewRow GridRow = datagrideview2.Rows[RowPos];
                    ...
                    else
                    {
                        ...
                        {
                            // Draw Header
                            e.Graphics.DrawString(PrintTitle, new Font(datagrideview2.Font, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top -
                            e.Graphics.MeasureString(PrintTitle, new Font(datagrideview2.Font,
                                    FontStyle.Bold), e.MarginBounds.Width).Height - 13);

                            String s = DateTime.Now.ToLongDateString() + " " + DateTime.Now.ToShortTimeString();

                            e.Graphics.DrawString(s, new Font(datagrideview2.Font, FontStyle.Bold),
                                    Brushes.Black, e.MarginBounds.Left + (e.MarginBounds.Width -
                                    e.Graphics.MeasureString(s, new Font(datagrideview2.Font,
                                    FontStyle.Bold), e.MarginBounds.Width).Width), e.MarginBounds.Top -
                                    e.Graphics.MeasureString(PrintTitle, new Font(new Font(datagrideview2.Font,
                    ...
                    int RowsPerPage)
        {
            ...
            if (PrintAllRows)
            {
                if (datagrideview2.Rows[datagrideview2.Rows.Count - 1].IsNewRow)
                    cnt = datagrideview2.Rows.Count - 2; // When the DataGridView doesn't allow adding rows
                else
                    cnt = datagrideview2.Rows.Count - 1; // When the DataGridView allows adding rows
            }
            else
                cnt = datagrideview2.SelectedRows.Count;

            // Writing the Page Number on the Bottom of Page
            string PageNum = PageNo.ToString() + " of " +
                Math.Ceiling((double)(cnt / RowsPerPage)).ToString();

            e.Graphics.DrawString(PageNum, datagrideview2.Font, Brushes.Black,
                e.MarginBounds.Left + (e.MarginBounds.Width -
                e.Graphics.MeasureString(PageNum, datagrideview2.Font,
